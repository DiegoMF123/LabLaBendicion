...
class Welcome extends CI_Controller {
    ...
    if (isset($usuario)) {
					...
					switch ($rol) {
						case '1':
												...
												if (empty($_REQUEST["region"])) {
																		// code...
																		// esta varaible data tambien trae la variable datos del foreach de la vista usuario, para que muestre los datos
																		...
																		if (isset($_REQUEST["region"])) {
																			...
																			// esta varia data muestra los datos del foreach que esta en la vista usuario
      ...
      header("Location: http://192.168.0.4:8888/LabLaBendicion/");
      die();
    }
			...
			//mostrará la pantalla principal
				foreach ($data["usuarios"] as $usu) {
						...
						if (($usu->Usuario == $user) and ($usu->Password == $pass)) {
							...
							header("Location: http://192.168.0.4:8888/LabLaBendicion/index.php/welcome");
							die();
