...
<head>
    ...
    <script language="JavaScript" type="text/javascript" src="<?php echo base_url(); ?>assets/js/validar.js">
    </script>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div class="pageheader hidden-xs">
                    <h3><i class="fa fa-home"></i>Ingreso de datos</h3>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Datos para soporte y contacto</h3>
                                </div>
                                        ...
                                        <div class="panel-body">
                                          ...
                                          si los datos se actualizan y hacen bien su proceso en el controlador Users y en el respectivo modelo. -->
                                            ...
                                            <form id="registrationForm" name="registrationForm" class="form-horizontal"
                                                action="" method="GET" onsubmit="return confirmar();">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3 col-xs-12">
                                                        <select class="form-control" name="tiposoporte" id="tiposoporte"
                                                            required>
                                                    ...
                                                    <div class="col-md-3 col-xs-12">
                                                        <input type="text" class="form-control" name="numsoporte"
                                                            id="numsoporte" placeholder="Ingrese el numero de soporte"
                                                            required />
                                                    </div>
                                                    ...
                                                    <div class="col-md-3 col-xs-12">
                                                        <input type="text" class="form-control" name="telefono"
                                                            id="telefono" placeholder="Ingrese un numero de teléfono"
                                                            required />
                                        ...
                                        <div class="panel-footer">
                                            <div class="form-group">
                                                <div class="col-md-5 col-xs-12">
                                                    ...
                                                    <input type="button" class="btn btn-info" name="" value="Regresar"
                                                        id="" onclick="back()">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form id="registrationForm" name="registrationForm" class="form-horizontal"
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" value="<?= $dato->NIT?>"
                                                        name="nit" id="nit" placeholder="NIT" readonly>
                                                    <br>
                                                </div>
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="nombre"
                                                        <?= $dato->Nombre?> id="nombre" value="" placeholder="Nombre"
                                                        readonly>
                                    ...
                                    <div class="panel-body">
                                        <form id="registrationForm" name="registrationForm" class="form-horizontal"
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <label class="col-sm-1 control-label">NIT </label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" value="" name="nit" id="nit"
                                                        placeholder="NIT" readonly>
                                                    <br>
                                                </div>
