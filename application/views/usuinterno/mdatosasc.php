...
<html lang="en">
    <head>
        ...
        <title>Pantalla de asociación</title>
      ...
      <script src="<?php echo base_url(); ?>/assets/plugins/pace/pace.min.js"></script>
        ...
        function confirmar() {
            ...
            Swal.fire({
                title: '¿Está seguro que desea asociar la solictud?',
                type: 'warning',
         ...
         <div class="boxed">
             ...
             <div id="content-container">
                 ...
                 <div class="pageheader hidden-xs">
                     ...
                     <h3><i class="fa fa-home"></i>Asociación de muestras</h3>
                 </div>
                 <div id="page-content">
                    <div class="row">
                          <div class="col-md-12">
                     <div class="panel">
                         ...
                         <div class="panel-body">
                                                      ...
                                                      <div >
                                                          ...
                                                          <a  href="http://192.168.0.7:8888/LabLaBendicion/index.php/mantenimientomm/asociarnuevo" class="btn btn-link btn-lg" data-toggle="tooltip" data-placement="right" title="Asociar">
                                     ...
                                     <li>
                                         ...
                                         <ul class="collapse">
                                           ...
                                           <li><a href="<?php echo base_url(); ?>index.php/mantenimientomm"><i class="fa fa-caret-right"></i>Análisis de muestras medicas / Clasificación / Mantenimiento</a></li>
                                               ...
                                               <li><a href="<?php echo base_url(); ?>index.php/IngQueja"><i class="fa fa-caret-right"></i>Opciones</a></li>
