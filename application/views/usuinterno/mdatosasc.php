...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/easyautocomplete/easy-autocomplete.themes.min.css">
    ...
    function confirmar() {
        ...
        Swal.fire({
            title: '¿Está seguro que desea asociar los items a la muestra?',
            type: 'warning',
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel">
                             ...
                             echo "<div class=\"alert alert-success fade in\" role=\"alert\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">
                                   Su asociación se ha realizado exitosamente.
                                 </div>";
                           } ?>
                                            ...
                                            list: {
                                              onSelectItemEvent: function() {
                                                var value = $("#function-data").getSelectedItemData().Presentacion;
                                                $("#data-holder").val(value).trigger("change");
                                                var value = $("#function-data").getSelectedItemData().NombreMuestra;
                                                $("#data-holder2").val(value).trigger("change");
                                                var value = $("#function-data").getSelectedItemData().Cantidad;
                                                $("#data-holder3").val(value).trigger("change");
                                                var value = $("#function-data").getSelectedItemData().Nombreum;
                                                $("#data-holder4").val(value).trigger("change");
                                                var value = $("#function-data").getSelectedItemData().Nombre_archivo;
                                                $("#data-holder5").val(value).trigger("change");
                                                var value = $("#function-data").getSelectedItemData().FechaCreacion;
                                                $("#data-holder6").val(value).trigger("change");
                                                var value = $("#function-data").getSelectedItemData().idSolicitud;
                                                $("#data-holder7").val(value).trigger("change");
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label
                                                                class="col-md-1 col-xs-12 control-label">Nombre muestra</label>
                                                            <div class="col-md-3 col-xs-12">
                                                            ...
                                                            <label
                                                                class="col-md-1 col-xs-12 control-label">Cantidad</label>
                                                            <div class="col-md-3 col-xs-12">
                                                                <input type="text" class="form-control" name="Nombre" id="data-holder3"
                                                                    value="" placeholder=""
                                                                    readonly />
                                                            </div>

                                                            <label
                                                                class="col-md-1 col-xs-12 control-label">Unidad de medida</label>
                                                            <div class="col-md-3 col-xs-12">
                                                                <input type="text" class="form-control" name="Nombre" id="data-holder4"
                                                                    value="" placeholder=""
                                                                    readonly />
                                                            </div>
                                                            <br>
                                                            ...
                                                            <label
                                                                class="col-md-1 col-xs-12 control-label">Archivo</label>
                                                            <div class="col-md-3 col-xs-12">
                                                                <input type="text" class="form-control" name="Nombre" id="data-holder5"
                                                                    value="" placeholder=""
                                                                    readonly />
                                                            </div>

                                                            <label
                                                                class="col-md-1 col-xs-12 control-label">Fecha de creación</label>
                                                            <div class="col-md-3 col-xs-12">
                                                                <input type="text" class="form-control" name="Nombre" id="data-holder6"
                                                                    value="" placeholder=""
                                                                    readonly />
                                                            </div>

                                                            <label
                                                                class="col-md-1 col-xs-12 control-label">Solicitud</label>
                                                            <div class="col-md-3 col-xs-12">
                                                                <input type="text" class="form-control" name="Nombre" id="data-holder7"
                                                                    value="" placeholder=""
                                                                    readonly />
                                                            </div>
                                                            ...
                                                            <label class="col-md-1 col-xs-12 control-label">Presentacion
                                                                </label>
                                                            <div class="col-md-3 col-xs-12">

                                                              <textarea rows="3"  id="data-holder" class="form-control" name="desc" cols="60" readonly></textarea>
